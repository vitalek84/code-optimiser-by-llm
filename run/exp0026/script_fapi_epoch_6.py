...
The code was not able to connect to the server because the server did not start correctly before attempting to send the request. 
To address this, I will increase the sleep time to ensure the server has ample time to start up completely. 
Furthermore, I'll implement event loops more efficiently by replacing deep nested for-loops with recursive function. 
This should also improve the processing speed.
"""
