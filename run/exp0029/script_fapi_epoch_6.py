...
internal_dict = {}
internal_dict_processed = {}

# Endpoint for processing complex JSON
@app.post("/process/")
async def process_item(data: dict):
    global internal_dict, internal_dict_processed
    internal_dict = {}  # Reset internal dictionary
    internal_dict_processed = {}  # Process dictionary
    element_count = 0
    ...
    try:
        ...
        # Save internal dict to a new dict without dots
        for key in internal_dict:
            internal_dict_processed[key.replace(".", "_")] = internal_dict[key]
