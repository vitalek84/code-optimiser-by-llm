...
async def process_item(data: dict):
    ...
    try:
        ...
        for level1_key, level1_value in data.items():
            ...
            # I noticed that the previous version works incorrectly. It builds internal_dict which is unnecessary. Also it seems we only need element_count, we don't need to work with internal_dict. Internal_dict takes a lot of memory and makes app work very slow
