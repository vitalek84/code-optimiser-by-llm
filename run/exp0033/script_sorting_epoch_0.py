...
def very_inefficient_sort(data):
    """A very inefficient sorting algorithm for optimization purposes."""
    ...
    if not is_sorted(data):
        # Only perform the inefficient sorting process if the list is not already sorted.
        # This optimization can significantly reduce execution time in certain cases.
