I noticed that the previous version works incorrectly. I analysed the issue and fixed it. Also, I understand that I shouldn't take into account execution time of the not working version.
...
"""
Chain of Thought:
1. Analyzed the error description provided and identified that the previous script had an unexpected termination.
2. Ensured all necessary imports are included.
3. Added error handling to capture and log exceptions more robustly.
4. Ensured that all functions and their logic remain consistent with the original code.
5. Optimized date conversion and filtering for better performance.
"""
