...
"""
The previous version had an issue where the 'element_count' variable was being accessed before it was properly initialized. 
This was causing an error. In this version, I have added proper initialization and fixed the logic to ensure that 
the server runs correctly and returns the expected results.
"""
