...
"""
I noticed that the previous version works incorrectly. I analysed the issue and fixed it. Also, I understand that I shouldn’t take to account execution time of not working version. Additionally, I optimized the JSON generation process to reduce unnecessary computations.
"""
